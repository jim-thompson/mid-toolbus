...
public class _TestCreatorApp extends CommandLine
{
	...
	protected byte execute()
	{
		try
		{
			...
			String location = "/Users/jct/Desktop/PoC.mdzip";
			...
			ProjectDescriptor proj_descriptor = ProjectDescriptorsFactory.
					createLocalProjectDescriptor(_project, new File(location));
			boolean did_save = proj_manager.saveProject(proj_descriptor, true);
